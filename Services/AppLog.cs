...
/// <summary>
/// Minimal append-only error log next to the settings file. Quota failures are
/// otherwise invisible once the dialog closes ("filled in the key but nothing
/// shows" was undiagnosable); this records only failure categories and server
/// messages — never the API key and never raw quota payloads.
/// </summary>
